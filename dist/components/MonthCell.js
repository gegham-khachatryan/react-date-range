...
var MonthCell = function (_Component) {
  _inherits(MonthCell, _Component);

  function MonthCell(props, context) {
    _classCallCheck(this, MonthCell);

    var _this = _possibleConstructorReturn(this, (MonthCell.__proto__ || Object.getPrototypeOf(MonthCell)).call(this, props, context));
  ...
  _createClass(MonthCell, [{
    ...
    value: function getClassNames() {
      ...
      return (0, _classnames5.default)(styles.monthCell, (_classnames = {}, _defineProperty(_classnames, styles.dayHovered, this.state.hover), _defineProperty(_classnames, styles.dayActive, this.state.active), _classnames));
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            null,
            (0, _format2.default)(this.props.quarter.start, 'MMM')
          )
        )
      );
    }
