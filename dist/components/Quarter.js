...
var _QuarterCell = require('./QuarterCell.js');
...
var Quarter = function (_PureComponent) {
  _inherits(Quarter, _PureComponent);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          Object.values((0, _utils.eachQuarterOfYear)(this.props.year)).map(function (quarter, index) {
            return _react2.default.createElement(_QuarterCell2.default, _extends({}, _this2.props, {
              ranges: ranges,
              quarter: quarter,
              key: index,
              styles: styles,
